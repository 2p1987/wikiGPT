...
def version2_export(model, filepath, group_size=64):
    ...
    for i, w in enumerate(weights):
        ...
        ), f"weight {i} has numel {w.numel()}, not a mult of group_size {group_size}"
    ...
    for i, w in enumerate(weights):
        ...
        print(
            f"{i+1}/{len(weights)} quantized {tuple(w.shape)} to Q8_0 w max error {err}"
        )
...
def hf_export(llama_model, filepath, group_size=64, dtype=torch.float32):
    ...
    # See: https://github.com/huggingface/transformers/blob/
    # b132c1703eb1c8bd9dfa4ad6a9be2bfd6ef819e9/src/transformers/models/
    # llama/convert_llama_weights_to_hf.py#L122
    ...
    def concat_weights(models):
        ...
        for name in list(models[0]):
            ...
            is_axis_1 = (
                ...
                or name.endswith(".attention.wo.weight")  # noqa
                or name.endswith(".feed_forward.w2.weight")  # noqa
            )
